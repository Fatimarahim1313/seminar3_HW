...
Мы получили базовые знания про системы контроля версий, изучили и настроили GitHub,создали первый репозиторий и внесли в него изменения,узнали про ветки, форки и остальное а также сделали первый ПР. 
